  ...
  return (
    <section className="w-full h-full flex p-10 gap-10 text-f-dark bg-[#f0f0f0] ">
      <div className="w-2/3 h-full flex flex-col gap-10">
        <section className="w-full h-2/5 flex gap-10">
          <div className="w-2/3 rounded-lg p-5 flex flex-col gap-3 bg-white">
            <article className="w-full h-1/5 flex justify-between">
              <section>
            ...
            <div className="w-full h-4/5 flex flex-col gap-5">
              <section className="w-full h-1/2 flex gap-5">
                <div className="w-1/2 h-full rounded-md bg-gradient-to-r from-sky-300 to-teal-400"></div>
                <div className="w-1/2  h-full rounded-md bg-gradient-to-r from-purple-300 to-red-400"></div>
              </section>
              <section className="w-full h-1/2 flex gap-5">
                <div className="w-1/2 h-full rounded-md bg-gradient-to-r from-yellow-300 to-orange-400"></div>
                <div className="w-1/2 h-full rounded-md bg-gradient-to-r from-blue-300 to-violet-400"></div>
              </section>
            </div>
          </div>
          <div className="w-1/3 rounded-lg p-5 flex flex-col gap-3 bg-white">
        ...
        <section className="w-full h-3/5 flex flex-col rounded-lg p-5 bg-white">
