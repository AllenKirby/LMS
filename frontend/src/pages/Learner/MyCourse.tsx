            ...
            >
              ...
              <section className="w-full flex flex-col gap-3">
                ...
                <div className="flex-1 flex flex-col gap-2">
                    ...
                    {["Course", "External Training"].map((category) => (
                      ...
                      >
                        <input
                          ...
                          checked={
                            selectedFilters[
                              formatKey(category) as keyof Filters
                            ] as boolean
                          }
                  ...
                  {/* Status Filter */}
                  <div className="w-full flex flex-col">
                    <p className="text-p-sm font-medium text-c-green-50">
                      Status
                    </p>
                    {["All", "In Progress", "Completed", "Saved"].map(
                      (status) => (
                        <label
                          key={status}
                          htmlFor={status}
                        ...
                        >
                          <input
                            ...
                            checked={
                              selectedFilters[
                                formatKey(status) as keyof Filters
                              ] as boolean
                            }
                            onChange={handleCheckboxChange}
                            className="mr-2"
