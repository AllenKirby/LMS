      ...
      <ul className="flex flex-row justify-between px-3">
        {user.user.role === "trainee" && (
          ...
          >
            ...
            <p className="flex flex-col items-center text-p-sm">
              <GoHome size={32} />
              <span>Home</span>
            </p>
          </NavLink>
        ...
        {user.user.role === "trainee" && (
          ...
          >
            <p className="hidden md:block">Course Library</p>
            <p className="flex flex-col items-center text-p-sm">
        ...
        {user.user.role === "training_officer" && (
          ...
          >
            <p className="hidden md:block">My Courses</p>
            <p className="flex flex-col items-center text-p-sm">
              <LiaBookSolid size={32} />
        ...
        {user.user.role === "training_officer" && (
          ...
          >
            <p className="hidden md:block">Trainee</p>
            <p className="flex flex-col items-center text-p-sm">
              <FiUsers size={32} />
              <span>Trainee</span>
            </p>
        ...
        <section className="flex items-center justify-center">
          <img
            alt="Profile IMG"
            className="w-12 h-12 rounded-full bg-c-green-20"
